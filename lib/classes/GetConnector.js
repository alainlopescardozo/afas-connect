...
class GetConnector extends Connector_1.default {
    ...
    getOne(getConnectorName, config) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            try {
                const url = this.connectorUrl + getConnectorName + this.parseConfig(Object.assign(Object.assign({}, (config || {})), { skip: 0, take: 1 }));
                const response = yield this.http(url, 'GET');
                return ((_a = response.rows) === null || _a === void 0 ? void 0 : _a[0]) || null;
            }
            catch (error) {
                throw new ProfitError_1.ProfitError('An error occurred trying to Get one of ' + getConnectorName, error);
            }
        });
    }
    /**
