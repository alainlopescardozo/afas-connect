...
class DataConnector extends Connector_1.default {
     ...
     *
     */
    file(fileId_1, fileName_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, fileName, binary = false) {
            try {
     ...
     *
     */
    image(format_1, imageId_1) {
        return __awaiter(this, arguments, void 0, function* (format, imageId, binary = false) {
            try {
     ...
     * @param binary {boolean} If true, will return the file in binary instead of { filedata, mimetype }
     */
    report(reportId_1, additionalFilter_1) {
        return __awaiter(this, arguments, void 0, function* (reportId, additionalFilter, binary = false) {
            try {
